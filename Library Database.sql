...
#subquery
select * from student where firstname in (select studentName from borrow where borrowdate="2020-6-24 05:30:12");
select * from book where bookname in (select bookname from borrow where borrowdate="2020-6-30 01:05:03");
