...
insert into borrow values (UUID(), "gehad" , "where is allah" ,  "2020-5-28" , "2020-6-28");
insert into borrow values (UUID(), "abdelrahman", "the way to happiness" ,  "2020-6-24" , "2020-7-13");
insert into borrow values (UUID(), "hend", "the way to happiness" ,  "2020-6-30" , "2020-8-12");
